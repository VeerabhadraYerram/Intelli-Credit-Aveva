...
export default function HitlDashboard() {
  ...
  // Simulated derived data based on slider fluidly ticking
  ...
  const handleDecision = async (approved) => {
    ...
    // Placeholder payload matching the backend schema
    const payload = {
      approved: approved,
    ...
    try {
      // TODO: Connect to your actual Flask/FastAPI endpoint here
      ...
      alert(`[Backend Mock] Command(resume) triggered with: ${JSON.stringify(payload)}`);
    } catch (err) {
    ...
    <div className="dashboard-container">
          ...
          <div className="telemetry-grid">
            <div className="telemetry-card">
              ...
              <div className="telemetry-val">
                <span className="tabular-num">80.0</span>
                <span className="delta positive">-2.1°C</span>
              </div>
            </div>
            <div className="telemetry-card">
              <span className="telemetry-label">Machine Speed (RPM)</span>
              <div className="telemetry-val">
                <span className="tabular-num">60.0</span>
            ...
            <div className="telemetry-card">
              ...
              <div className="telemetry-val">
                <span className="tabular-num">25.0</span>
      ...
      <div className="right-column">
        ...
        <GlowCard className="execution-gate">
          <div>
            <h2 style={{ margin: 0, letterSpacing: '1px' }}>Pending AI Recommendation</h2>
            <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>Batch ID: LIVE-001</p>
          </div>
