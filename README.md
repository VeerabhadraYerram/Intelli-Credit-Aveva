...
![Intelli-Credit-Aveva Architecture V2.0](./architecture.png)
*(Note: Please ensure the architecture diagram is named `architecture.png` and placed in the root directory).*
